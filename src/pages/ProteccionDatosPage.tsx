  ...
  return (
    <Box sx={{ mt: 4, mb: 4, px: { xs: 2, sm: 4, md: 6 } }}>
      <section id="proteccion">
        ...
        <Box sx={{ mb: 4 }}>
          {/* Subtítulo con variante definida en theme */}
          <Typography variant="h3" component="h3" gutterBottom sx={{ fontWeight: 'bold' }}>
            Marco Legal Aplicable
          </Typography>
          <List sx={{ listStyleType: 'disc', pl: 4 }}>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary="Ley de Protección de Datos Personales en Posesión de Sujetos Obligados del Estado de Nuevo León." />
            </ListItem>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary={<><strong>Artículo 10 de la Ley General de Desarrollo Social:</strong> Derecho de los beneficiarios a la privacidad de su información.</>} />
            </ListItem>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary={<><strong>Artículo 6° de la Constitución Política de los Estados Unidos Mexicanos:</strong> Principio de máxima publicidad y protección de datos.</>} />
            </ListItem>
          </List>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <List sx={{ listStyleType: 'disc', pl: 4 }}>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary={<><strong>Licitud y finalidad:</strong> Los datos son recabados con fines específicos de política social, no se utilizan con fines comerciales o electorales.</>} />
            </ListItem>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary={<><strong>Proporcionalidad:</strong> Solo se publica la información mínima necesaria para cumplir con los objetivos de transparencia.</>} />
            </ListItem>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary={<><strong>Responsabilidad:</strong> Las dependencias son responsables del correcto uso, actualización y resguardo de los datos.</>} />
            </ListItem>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary={<><strong>Seguridad:</strong> El portal emplea medidas técnicas y administrativas para proteger la integridad de los datos.</>} />
            </ListItem>
          </List>
        </Box>
