...
const QueEsElPadronPage: React.FC = () => {
  return (
    <Box sx={{ mt: 4, mb: 4, px: { xs: 2, sm: 4, md: 6 } }}>
      <BackToPadron />
      <section id="que-es">
        {/* H2 controlado por theme (sin sx.fontSize) */}
        <Typography
          variant="h2"
          component="h2"
          gutterBottom
        ...
        <Box sx={{ mb: 4 }}>
          {/* Subtítulo con variant definida en theme */}
          ...
          <List sx={{ listStyleType: 'disc', pl: 4 }}>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary="Registro nominal: Identifica a las personas físicas o morales que han sido beneficiadas por los programas sociales." />
            </ListItem>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary="Transparencia: Permite que la ciudadanía supervise y consulte los apoyos otorgados con recursos públicos." />
            </ListItem>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary="Evaluación: Facilita el monitoreo del alcance, cobertura e impacto de los programas sociales." />
            </ListItem>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary="Planeación: Sirve de insumo para ajustar políticas públicas y focalizar mejor los recursos del Estado." />
            </ListItem>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary="Prevención de duplicidades: Ayuda a evitar que una misma persona o entidad reciba múltiples apoyos injustificados." />
            </ListItem>
          </List>
        </Box>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <List sx={{ listStyleType: 'disc', pl: 4 }}>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary="Nombre del beneficiario (cuando sea legalmente permitido)" />
            </ListItem>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary="Edad y sexo" />
            </ListItem>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary="Ubicación geográfica (municipio o región)" />
            </ListItem>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary="Nombre del programa social" />
            </ListItem>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary="Tipo de apoyo recibido (monetario, en especie o en servicios)" />
            </ListItem>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary="Monto del beneficio" />
            </ListItem>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary="Dependencia ejecutora del programa" />
            </ListItem>
            <ListItem sx={{ display: 'list-item', p: 0, mb: 1 }}>
              <ListItemText primary="Fecha de entrega del apoyo" />
            </ListItem>
          </List>
        </Box>
